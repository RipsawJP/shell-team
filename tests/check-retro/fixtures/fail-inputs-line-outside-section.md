...
- 理解の負債: `<unread/weakly-understood generated code — 出典>`
- レビュー基準の再言語化: `<one or two sentences>`
- 未検証の自己申告: `<claims without evidence>`
...
- `<none>`
- input: cycle-window — status: read — detail: a ledger-shaped line stranded outside the section
